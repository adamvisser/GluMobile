...
ADD docker-configs/www.conf /etc/php/7.2/fpm/pool.d/www.conf
...
ADD docker-configs/default /etc/nginx/sites-enabled/
ADD docker-configs/nginx.conf /etc/nginx/
...
ADD docker-configs/supervisord.conf /etc/supervisor/conf.d/supervisord.conf
